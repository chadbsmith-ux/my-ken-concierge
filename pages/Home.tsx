...
const Home: React.FC = () => {
  return (
    <div className="relative">
      {/* Hero Section */}
      <div className="relative h-[90vh] md:h-[95vh] flex items-center overflow-hidden">
        {/* Background Layer */}
        <div className="absolute inset-0 bg-black">
          <div 
            className="absolute inset-0 bg-cover bg-center opacity-60 scale-105 animate-slow-zoom"
            style={{ 
              backgroundImage: `url('https://i.imgur.com/oRCxrUH.png')`,
              backgroundPosition: 'center 20%'
            }}
            role="img"
            aria-label="Luxury lifestyle reference image"
          ></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pink-500/10 border border-pink-500/20 mb-8 backdrop-blur-md">
              ...
              <span className="text-pink-500 text-[10px] md:text-xs font-black uppercase tracking-[0.3em]">The Elite Social Concierge</span>
            </div>
            
            <h1 className="font-serif-elegant text-5xl md:text-8xl lg:text-9xl mb-8 leading-[0.9] tracking-tighter text-white">
              Design Your <br />
              <span className="italic pink-gradient">Storybook</span> <br />
              Moment.
            </h1>
            
            <p className="text-lg md:text-2xl text-stone-200 max-w-xl mb-12 leading-relaxed font-light drop-shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Link
                to="/design-my-date"
                className="bg-pink-500 text-white px-10 py-5 rounded-full text-lg md:text-xl font-black hover:bg-pink-400 transition-all transform hover:scale-105 shadow-[0_0_30px_rgba(236,72,153,0.3)] text-center"
              >
                Design My Date
              </Link>
              <Link
                to="/kens"
                className="group flex items-center justify-center gap-4 px-10 py-5 rounded-full border border-stone-500 text-white text-lg md:text-xl font-bold hover:bg-white/10 backdrop-blur-sm transition-all text-center"
              >
                Meet the Roster
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-stone-400 text-base md:text-lg leading-relaxed">We don't just provide companionship; we curate cinematic social experiences tailored to your highest standards.</p>
            </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="relative group p-8 md:p-10 rounded-[2rem] bg-stone-900/30 border border-stone-900 hover:border-pink-500/30 transition-all duration-500">
      ...
      <section className="py-24 md:py-32 bg-stone-950">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-stone-400 leading-relaxed mb-16 font-light max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-x-12 gap-y-6 text-stone-500 font-black uppercase tracking-[0.2em] text-[9px] md:text-[10px]">
            ...
            <div className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-pink-500 rounded-full shadow-[0_0_10px_rgba(236,72,153,0.8)]"></span> Background Checks</div>
            <div className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-pink-500 rounded-full shadow-[0_0_10px_rgba(236,72,153,0.8)]"></span> Privacy Shield</div>
          </div>
        </div>
      </section>
    </div>
